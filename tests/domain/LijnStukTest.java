...
public class LijnStukTest {
	...
	@Test
	public void equals_moet_true_teruggeven_als_eerste_eindpunt_gelijk_is_aan_andere_beginpunt_en_een_eindpunt_gelijk_is_aan_andere_zijn_beginpunt() throws DomainException {
		LijnStuk lijnStuk = new LijnStuk(punt1, punt2);
		LijnStuk lijnStukPuntenOmgedraaid = new LijnStuk(zelfdeAlsPunt2, zelfdeAlsPunt1);
		assertTrue(lijnStuk.equals(lijnStukPuntenOmgedraaid));
	}

	@Test(expected = DomainException.class)
	public void Lijnstuk_Moet_Exception_gooien_als_begin_en_eindpunt_gelijk_zijn() throws DomainException{
