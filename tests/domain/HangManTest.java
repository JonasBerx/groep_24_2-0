...
public class HangManTest {
    ...
    @Before
    public void setUp() throws Exception, DbException, DomainException {
    ...
    @Test (expected = DomainException.class)
    public void HangMan_moet_een_exception_gooien_als_gegeven_woordenlijst_leeg() throws DomainException, DbException {
