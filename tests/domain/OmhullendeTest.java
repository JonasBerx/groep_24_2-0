...
public class OmhullendeTest {
	...
	@Test
	public void getMinimumX_geeft_juiste_xCoordinaat_terug(){
		assertEquals(200, omhullende.getMinimumX());
	}

	@Test
	public void getMinimumY_geeft_juiste_yCoordinaat_terug(){
		assertEquals(160, omhullende.getMinimumY());
	}

	@Test
	public void getMaximumX_geeft_juiste_xCoordinaat_terug(){
		assertEquals(220, omhullende.getMaximumX());
	}

	@Test
	public void getMaximumY_geeft_juiste_yCoordinaat_terug(){
		assertEquals(200, omhullende.getMaximumY());
	}
