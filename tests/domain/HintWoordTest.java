...
public class HintWoordTest {
    ...
    @Test
    public void HintWoord_moet_HintWoord_aanmaken_waarvan_alle_letters_verborgen_zijn_met_spaties() throws DomainException {
        String woord = "test test";

        HintWoord hint = new HintWoord(woord);

        assertEquals(woord, hint.getWoord());

        assertEquals("_ _ _ _  _ _ _ _", hint.toString());
        assertFalse(hint.isGeraden());
    }
